...
figlet WolfPack Cyber | lolcat

echo "_____________________________________________________________"
echo "Tools    : Kumpulan Tools Hacker $white                         " |lolcat
echo "Creadby  : Tuan Misfits $white                                      " |lolcat
echo "Contact  : 085246068711  $white                             " |lolcat
echo "_____________________________________________________________"
...
6) echo "created by : Tuan Misfits" | lolcat
exit
;;
